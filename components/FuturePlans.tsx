const plans = [
  ...
  { title: 'Closed-loop intervention with a robotic mouse', titleZh: '机器鼠闭环神经干预',
    body: 'I plan to use MPN population activity and dopamine signals to guide the robot’s social interactions in a closed-loop system, with subsequent evaluation in animal models of social dysfunction.',
    bodyZh: '我计划构建依据 MPN 神经群体活动与多巴胺信号调整机器鼠互动策略的闭环系统，并进一步在社交障碍动物模型中评估其作用。' },
  ...
  { title: 'Memory and authority in long-term, multi-user AI interaction', titleZh: '长期、多人 AI 交互中的记忆与权限',
    body: 'Building on MORI and ReGround, I plan to study experience reuse and authorization in long-term, multi-user AI interaction, including the relationships between role changes, privacy, and task performance.',
    bodyZh: '基于 MORI 与 ReGround，我计划研究长期、多人 AI 交互中的经验重用与授权问题，考察角色变化、隐私与任务表现之间的关系。' },
];
  ...
  return <section className="section future-plans" id="future-plans">
    ...
    <details className="future-plan-details">
      ...
      <div className="future-plan-details-content">
        ...
        <p className="future-plans-intro" data-lang="zh">以下包括正在推进的研究计划与尚处于构想阶段的长期方向。</p>
