...
export function HardwareDebugDetails({ src }: { src: string }) {
  ...
  return <section className="hardware-debug-details">
    ...
    <figure className="hardware-pcb-detail"><FigureViewer src="/ads1299-pcb.jpg" alt="ADS1299–STM32 acquisition board PCB layout" /><figcaption><span data-lang="en">PCB layout of the acquisition board</span><span data-lang="zh">采集板 PCB 设计图</span></figcaption></figure>
    ...
    <figure><FigureViewer src="/usb-isolation-reference.png" alt="ADuM4160 reference circuit reproduced in the project debugging presentation" /><figcaption><span data-lang="en">Reference circuit used during the initial design, reproduced in my debugging notes from the ADuM4160 data sheet. This is not the revised circuit.</span><span data-lang="zh">初始设计参考电路，调试记录中引用自 ADuM4160 数据手册；此图不是修改后的电路。</span></figcaption></figure>
  </section>;
}
